...
class RoleAdapter(context: Context, val list: List<User.Role>) : BaseAdapter() {
    ...
    override fun getItem(position: Int): User.Role {
    ...
    override fun getView(position: Int, view: View?, p2: ViewGroup?): View? {
        ...
        holder.txtTitle?.text = getItem(position).role
        return convertView
    }
